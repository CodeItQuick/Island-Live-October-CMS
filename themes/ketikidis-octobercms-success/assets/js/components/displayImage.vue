    ...
    export default {
        ...
        methods: {
            ...
            getToggle: function () {
                ...
                if (VuexStore.getters.getToggleData) {
                    return true;
                }
                else {
                    return false;
            ...
            isDown: function () {
                return VuexStore.getters.isDown;
            },
            getIsPrevious: function () {
